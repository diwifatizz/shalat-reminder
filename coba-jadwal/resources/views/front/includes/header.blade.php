    ...
    <div class="container px-0">
        <nav class="navbar navbar-light navbar-expand-xl">
            <a href="index.html" class="navbar-brand mt-3">
                <p class="text-primary display- mb-4" style="line-height: 0;"><strong>ShalatReminder.net</strong></p>
                <small class="text-body fw-normal" style="letter-spacing: 2px;">Jadwal-Waktu-Sholat dan Artikel</small>
            </a>
