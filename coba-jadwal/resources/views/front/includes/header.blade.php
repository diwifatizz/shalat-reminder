...
<a href="#">
    <p class="text-white mb-0 link-hover">Jadwal Shalat lima waktu dan artikel terbaru</p>
</a>
</div>
</div>
</div>
    ...
    <div class="container px-0">
        <nav class="navbar navbar-light navbar-expand-xl">
            ...
            <div class="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                ...
                <div class="d-flex flex-nowrap border-top pt-3 pt-xl-0" id="weather-container">
                    <div class="d-flex">
                        <img  class="img-fluid w-100 me-2" alt="">
                        <div class="d-flex align-items-center">
                            <div class="d-flex flex-column ms-2" style="width: 150px;">
                                <span class="text-body">Indonesia</span>
                                <small id="date-time">Loading...</small>
                            </div>
                        </div>
                    </div>
                </div>
