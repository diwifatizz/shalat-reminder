    ...
    <div class="container px-0">
        <nav class="navbar navbar-expand-xl navbar-light bg-transparent">
            <a href="#" class="navbar-brand mt-3">
                <p class="text-primary mb-6" style="line-height: 0; font-size:23px;">Shalat Reminder</p>
            ...
            <div class="collapse navbar-collapse bg-transparent py-3" id="navbarCollapse">
                ...
                <div class="navbar-nav mx-auto border-top">
                    ...
                    <a href="{{ route('jadwalshalat.index') }}" class="nav-item nav-link {{ request()->is('jadwalshalat*') ? 'active' : '' }}">Jadwal Shalat</a>
