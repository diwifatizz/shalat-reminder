    ...
    <div class="row g-5">
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="footer-item-1">
                <h4 class="mb-8 text-white">Get In Touch</h4>
                <p class="text-secondary line-h">Address: <a href="https://maps.app.goo.gl/8KqtT5Y7oDhPvHAD7" class="text-white" target="_blank">Jl. HR. Soebrantas No.118, Sidomulyo Bar., Kec. Tampan, Kota Pekanbaru, Riau 28293</a></p>
