...
<div class="panel-header bg-primary-gradient">
	<div class="page-inner py-5">
		<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
			<div>
				<h2 class="text-white pb-2 fw-bold">Tabel Jadwal</h2>
				<h5 class="text-white op-7 mb-2">Jadwal Shalat {{ Auth::user()->level }}</h5>
			</div>
    ...
    <div class="container-shalat">
        <div class="card">
            <div class="card-header">
                <h3 style="color:rgb(3, 23, 41)">Jadwal-Shalat  {{ $city }} Bulan {{ $month }} Tahun {{ $year }}</h3>
